...
namespace SmartHotel.Clients.Core.Controls
{
	public partial class Calendar : ContentView
	{
		...
		public static readonly BindableProperty WeekdaysFontSizeProperty =
			BindableProperty.Create(nameof(WeekdaysFontSize), typeof(double), typeof(Calendar), (Device.Idiom == TargetIdiom.TV) ? 54.0 :18.0,
		...
		protected void ChangeWeekdaysFontSize(double newValue, double oldValue)
		{
			...
			dayLabels.ForEach(l => l.FontSize = (Device.Idiom == TargetIdiom.TV) ? 54.0 : newValue);
		}
